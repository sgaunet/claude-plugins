...
# CLAUDE.md Token Counter

Monitor the token count of CLAUDE.md files to ensure they stay within the recommended 2500 token limit. This skill analyzes the current token usage and provides reduction recommendations when the limit is exceeded.
