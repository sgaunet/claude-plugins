...
Automatically generate or enhance a project-specific CLAUDE.md file following 2025-2026 best practices. This skill performs deep codebase analysis to create comprehensive project documentation that stays within the 2500 token limit.
...
- Use Read tool to load `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/behavioral-guidelines-section.md`
- If it fails: Exit with error "Skill asset not found at ${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/behavioral-guidelines-section.md. Plugin may be corrupted. Reinstall the software-engineering plugin."
...
[Insert the `## Behavioral Guidelines` section verbatim from ${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/behavioral-guidelines-section.md — the asset carries its own H2 heading. Do NOT paraphrase, reorder, renumber, or compress.]
...
- Use Read tool to verify these assets exist in `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/`:
  - `architecture-template.md`
  - `workflows-template.md`
  - `patterns-template.md`
  - `operating-guidelines.md`
- If any fails: Exit with error "Skill assets directory not found or incomplete at ${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/. Plugin may be corrupted. Reinstall the software-engineering plugin."
...
- Read template from `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/architecture-template.md`
- Populate placeholders with Phase 1 agent results

**docs/workflows.md** (30-50 lines):
- Read template from `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/workflows-template.md`
- Populate placeholders with Phase 1 agent results

**docs/patterns.md** (30-50 lines):
- Read template from `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/patterns-template.md`
- Populate placeholders with Phase 1 agent results

**docs/operating-guidelines.md** (static, ~110 lines):
- Read file from `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/operating-guidelines.md`
...
3. **Markdown validity:**
   ...
   - **Verbatim integrity**: the emitted `## Behavioral Guidelines` block matches `${CLAUDE_PLUGIN_ROOT}/assets/gen-claude/behavioral-guidelines-section.md` byte-for-byte. If it does not, re-splice from the asset — do not hand-repair
...
- If still fails: use minimal analysis (Glob/Grep from the main skill, not agents)
