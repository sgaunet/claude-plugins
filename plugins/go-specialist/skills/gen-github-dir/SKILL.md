...
4. **Verify skill assets directory:**
   - Use Read tool to verify `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/FUNDING.yml` exists
...
5. **Check existing mise.toml:**
   ...
   - Store `existingMise = true|false`. The workflows depend on `mise.toml`; if it
     is missing this skill will create one (Phase 3.5). An existing `mise.toml`
     is always preserved.
...
**Read all template files** from skill assets directory:

**Files to read:**

1. **FUNDING.yml**
   - Path: `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/FUNDING.yml`
   - Target: `.github/FUNDING.yml`

2. **dependabot.yml**
   - Path: `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/dependabot.yml`
...
Complete mapping from skill assets to target locations:

| Source Path | Target (Relative to CWD) | Mode |
|-------------|--------------------------|------|
| `${CLAUDE_PLUGIN_ROOT}/assets/mise/mise.toml` | `mise.toml` | Create-if-missing |
| `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/FUNDING.yml` | `.github/FUNDING.yml` | Standard |
| `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/dependabot.yml` | `.github/dependabot.yml` | All |
| `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/workflows/linter.yml` | `.github/workflows/linter.yml` | All |
| `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/workflows/coverage.yml` | `.github/workflows/coverage.yml` | Standard |
| `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/workflows/snapshot.yml` | `.github/workflows/snapshot.yml` | Standard |
| `${CLAUDE_PLUGIN_ROOT}/assets/github-workflows/workflows/release.yml` | `.github/workflows/release.yml` | All |
...
1. **mise.toml** (auto-created by this skill if missing):
...
3. Review skill documentation: `${CLAUDE_PLUGIN_ROOT}/docs/`
...
- Generate .goreleaser.yml (use `/gen-goreleaser` skill)
- Generate .golangci.yml (use `/gen-linter` skill)
